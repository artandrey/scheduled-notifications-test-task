...
export type DrizzleScheduledNotification = typeof schema.scheduledNotifications.$inferSelect;
export type DrizzleProcessedEvent = typeof schema.processedEvents.$inferSelect;
